...
class AddForeignKeysToPermissionRoleTable extends Migration
{
    ...
    public function up()
    {
        Schema::table('permission_role', function (Blueprint $table) {
            $table->foreign('permission_id', 'fk_permisson_role_to_permission')
            ->references('id')->on('permission')->onUpdate('CASCADE')->onDelete('CASCADE');
            $table->foreign('role_id', 'fk_permisson_role_to_role')
    ...
    {
        Schema::table('permission_role', function (Blueprint $table) {
            $table->dropForeign('fk_permisson_role_to_permission');
